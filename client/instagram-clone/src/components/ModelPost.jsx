...
export default function Modal() {
	...
	return (
		<>
			<div className=" flex justify-start mx-auto max-w-[1240px] ">
				<button
					className="inline-flex items-center justify-center w-10 h-10 mr-2 text-black-900 transition-colors duration-150 bg-gray-200 rounded-lg focus:shadow-outline hover:bg-black-800 "
					type="button"
